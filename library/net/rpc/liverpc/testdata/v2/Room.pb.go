...
func (*RoomGetByIdsReq) Descriptor() ([]byte, []int) {
	return fileDescriptor_Room_e067ee7741c8e8e8, []int{0}
}
...
type RoomGetByIdsResp struct {
	...
	Data map[string]*RoomGetByIdsResp_RoomInfo `protobuf:"bytes,3,rep,name=data" json:"data,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value"`
}
...
func (*RoomGetByIdsResp) Descriptor() ([]byte, []int) {
	return fileDescriptor_Room_e067ee7741c8e8e8, []int{1}
}
...
func (*RoomGetByIdsResp_RoomInfo) Descriptor() ([]byte, []int) {
	return fileDescriptor_Room_e067ee7741c8e8e8, []int{1, 1}
}
...
func init() { proto.RegisterFile("v2/Room.proto", fileDescriptor_Room_e067ee7741c8e8e8) }

var fileDescriptor_Room_e067ee7741c8e8e8 = []byte{
