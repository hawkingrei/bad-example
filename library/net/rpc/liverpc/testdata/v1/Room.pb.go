...
func (*RoomGetInfoByIdReq) Descriptor() ([]byte, []int) {
	return fileDescriptor_Room_0225d33a9603c337, []int{0}
}
...
type RoomGetInfoByIdResp struct {
	...
	Data map[string]*RoomGetInfoByIdResp_RoomInfo `protobuf:"bytes,3,rep,name=data" json:"data,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value"`
}
...
func (*RoomGetInfoByIdResp) Descriptor() ([]byte, []int) {
	return fileDescriptor_Room_0225d33a9603c337, []int{1}
}
...
func (*RoomGetInfoByIdResp_RoomInfo) Descriptor() ([]byte, []int) {
	return fileDescriptor_Room_0225d33a9603c337, []int{1, 1}
}
...
func (*RoomGetInfoReq) Descriptor() ([]byte, []int) {
	return fileDescriptor_Room_0225d33a9603c337, []int{2}
}
...
type RoomGetInfoResp struct {
	Code int64                 `protobuf:"varint,1,opt,name=code,proto3" json:"code,omitempty"`
	Msg  string                `protobuf:"bytes,2,opt,name=msg,proto3" json:"msg,omitempty"`
	Data *RoomGetInfoResp_Data `protobuf:"bytes,3,opt,name=data" json:"data,omitempty"`
}
...
func (*RoomGetInfoResp) Descriptor() ([]byte, []int) {
	return fileDescriptor_Room_0225d33a9603c337, []int{3}
}
...
func (*RoomGetInfoResp_PendantWithDesc) Descriptor() ([]byte, []int) {
	return fileDescriptor_Room_0225d33a9603c337, []int{3, 0}
}
...
func (*RoomGetInfoResp_Pendant) Descriptor() ([]byte, []int) {
	return fileDescriptor_Room_0225d33a9603c337, []int{3, 1}
}
...
type RoomGetInfoResp_Pendants struct {
	Frame       *RoomGetInfoResp_PendantWithDesc `protobuf:"bytes,1,opt,name=frame" json:"frame,omitempty"`
	Badge       *RoomGetInfoResp_PendantWithDesc `protobuf:"bytes,2,opt,name=badge" json:"badge,omitempty"`
	MobileFrame *RoomGetInfoResp_Pendant         `protobuf:"bytes,3,opt,name=mobile_frame,json=mobileFrame" json:"mobile_frame,omitempty"`
	MobileBadge *RoomGetInfoResp_Pendant         `protobuf:"bytes,4,opt,name=mobile_badge,json=mobileBadge" json:"mobile_badge,omitempty"`
}
...
func (*RoomGetInfoResp_Pendants) Descriptor() ([]byte, []int) {
	return fileDescriptor_Room_0225d33a9603c337, []int{3, 2}
}
...
type RoomGetInfoResp_Data struct {
	...
	HotWords             []string                  `protobuf:"bytes,26,rep,name=hot_words,json=hotWords" json:"hot_words,omitempty"`
	...
	NewPendants          *RoomGetInfoResp_Pendants `protobuf:"bytes,29,opt,name=new_pendants,json=newPendants" json:"new_pendants,omitempty"`
...
func (*RoomGetInfoResp_Data) Descriptor() ([]byte, []int) {
	return fileDescriptor_Room_0225d33a9603c337, []int{3, 3}
}
...
func init() { proto.RegisterFile("v1/Room.proto", fileDescriptor_Room_0225d33a9603c337) }

var fileDescriptor_Room_0225d33a9603c337 = []byte{
