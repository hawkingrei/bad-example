...
var (
	...
	// Less6000Notice is.
	Less6000Notice = &Notice{Title: "你的节操值已低于60", Message: "抱歉，你的节操值已低于60，社交类功能将不能正常使用，更多加减明细请查看 #{节操记录}{\"https://account.hhhhhh.com/site/record?type=moral\"}", NoticeType: "2_1_5"}
	// Less3000Notice is.
	Less3000Notice = &Notice{Title: "你的节操值已低于30", Message: "抱歉，你的节操值已低于30，社交类功能将不能正常使用，更多加减明细请查看 #{节操记录}{\"https://account.hhhhhh.com/site/record?type=moral\"}", NoticeType: "2_1_6"}
	// Greater6000Notice is .
	Greater6000Notice = &Notice{Title: "你的节操值已恢复至60以上", Message: "恭喜，你的节操值已恢复至60以上，所有功能将回复正常使用，更多加减明细请查看 #{节操记录}{\"https://account.hhhhhh.com/site/record?type=moral\"}", NoticeType: "2_1_7"}
	// PunishmentNotice is.
	PunishmentNotice = &Notice{Title: "你被举报处理扣除了%s节操值", Message: "由于发布了违规内容，你被举报处理扣除了%s节操值，具体原因请看 #{节操记录}{\"https://account.hhhhhh.com/site/record?type=moral\"}"}
	// SysPunishmentNotice is.
	SysPunishmentNotice = &Notice{Title: "你被举报处理扣除了%s节操值", Message: "由于发布了违规内容，你被系统处理扣除了%s节操值，具体原因请看 #{节操记录}{\"https://account.hhhhhh.com/site/record?type=moral\"}"}
	// RewardNotice is.
	RewardNotice = &Notice{Title: "你举报的%s已被处理", Message: "您举报的%s已被管理员处理，获得了%s节操值奖励，具体详情请看 #{节操记录}{\"https://account.hhhhhh.com/site/record?type=moral\"}"}
)
